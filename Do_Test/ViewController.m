...
- (void) InitInstance
{
    ...
    //在下面构造model
//    model = [[do_FrameAnimationView_UIModel alloc]init];
    
    //如果是UI类型，还需要构造view
//    [[doServiceContainer Instance].UIModuleFactory RegistGroup:[[doUIModuleGroup alloc]init] ];
}
- (void)ConfigUI {
...
- (void)test1:(UIButton *)sender
{
    ...
    [[doService Instance] SyncMethod:model :@"start" :nil];
